...
import type { AdapterPeerConnection } from "../transport/webrtc-adapter.js";
...
export function createAnswer(
  ...
  return new Promise<string>((resolve, reject) => {
    ...
    peer.onGatheringStateChange((gatheringState: string) => {
      if (gatheringState !== "complete" || settled) return;
