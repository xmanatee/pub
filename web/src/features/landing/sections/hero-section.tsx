  ...
  return (
    <section className="relative overflow-hidden">
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-primary/12 rounded-full blur-3xl" />
      </div>
      ...
      <div className="px-4 sm:px-6">
        <div className="pt-24 pb-20 sm:pt-32 sm:pb-28 text-center">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
            Your agent builds the right interface for the right moment. Data, apps, experiences —
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Button
              ...
              asChild
              onClick={() => trackCtaClicked({ cta: "get_started", location: "hero" })}
            >
              <Link to="/login">
                Get started
          ...
          <div className="mt-16 max-w-xl mx-auto">
            <TerminalPreview className="shadow-2xl shadow-primary/10">
              <div className="p-5 font-mono text-sm leading-relaxed">
                <div className="text-white/40">$ curl -fsSL pub.blue/install.sh | bash</div>
                <div className="text-emerald-400 mt-1">pub installed to /usr/local/bin/pub</div>
              </div>
            </TerminalPreview>
          </div>
        </div>
